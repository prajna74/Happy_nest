    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(mContext,Requestrent.class);
                i.putExtra("Rname",mData.get(position).getName());
                i.putExtra("Rcontactno",mData.get(position).getContactNo());
                i.putExtra("RAddress",mData.get(position).getAddress());
                i.putExtra("Homeid",mData.get(position).getHomeId());
